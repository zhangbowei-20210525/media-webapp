...
export class LazyService {
  ...
  private notify$: BehaviorSubject<LazyResult[]> = new BehaviorSubject<LazyResult[]>([]);
  ...
  async load(paths: string | string[]): Promise<LazyResult[]> {
    ...
    // const promises = paths.map(path => path.endsWith('.js') ? this.loadScript(path) : this.loadStyle(path));
